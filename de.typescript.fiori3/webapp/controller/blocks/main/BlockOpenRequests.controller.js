sap.ui.define([
    ...
    class BlockOpenRequests extends BaseController {
        constructor() {
            ...
            const fnClass = BaseController.extend('de.typescript.fiori3.TsApp.controller.BlockOpenRequests', {});
            BlockOpenRequests.prototype.getMetadata = fnClass.prototype.getMetadata;
            super('de.typescript.fiori3.TsApp.controller.BlockOpenRequests');
        }
        onInit() {
            // @ts-ignore
