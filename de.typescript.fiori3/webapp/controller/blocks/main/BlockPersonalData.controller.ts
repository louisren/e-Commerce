	...
	function (
		...
		class BlockPersonalData extends BaseController {
			...
			constructor() {
				...
				const fnClass = BaseController.extend('de.typescript.fiori3.TsApp.controller.BlockPersonalData', {})
				BlockPersonalData.prototype.getMetadata = fnClass.prototype.getMetadata

				super('de.typescript.fiori3.TsApp.controller.BlockPersonalData')
			}
