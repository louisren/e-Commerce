sap.ui.define(
	...
	function (
		...
		Component: typeof de.typescript.fiori3.TsApp.Component,
		...
		class BaseController extends Controller {
			...
			public getOwnerAppComponent(): de.typescript.fiori3.TsApp.Component {
				...
				const comp = (this.getOwnerComponent() as any) as de.typescript.fiori3.TsApp.Component
				return comp
			}
