sap.ui.define(['sap/ui/core/util/MockServer', 'sap/base/Log'], function (MockServer, Log) {
    ...
    class TsAppMockServer {
        constructor() {
            this._prefix = 'de/typescript/fiori3/TsApp';
        }
        /**
        ...
        createGetUserList() {
            ...
            return {
                ...
                response: (xhr) => {
                    ...
                    //@ts-ignore
                    let filteredUserList = that._userListModel.getProperty('/users');
                    if (filteredUserList) {
