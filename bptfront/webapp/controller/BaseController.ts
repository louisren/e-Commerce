	...
	function (
		...
		class BaseController extends Controller {
			...
			constructor() {
				...
				const fnClass = Controller.extend('bptfront.TsApp.controller.BaseController', {})
				BaseController.prototype.getMetadata = fnClass.prototype.getMetadata

				super('bptfront.TsApp.controller.BaseController')
			}

			// eslint-disable-next-line @typescript-eslint/no-empty-function
			public onInit(): void {}

			public getOwnerAppComponent(): bptfront.TsApp.Component {
				...
				const comp = (this.getOwnerComponent() as any) as bptfront.TsApp.Component
				return comp
			}
