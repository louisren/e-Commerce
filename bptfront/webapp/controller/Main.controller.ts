sap.ui.define(
	...
	function (
		...
		Formatter: typeof bptfront.TsApp.formatter.Formatter
	) {
		'use strict'
		...
		class Main extends BaseController {
			formatter: bptfront.TsApp.formatter.Formatter
			...
			constructor() {
				...
				const fnClass = BaseController.extend('bptfront.TsApp.controller.Main', {})
				Main.prototype.getMetadata = fnClass.prototype.getMetadata

				super('bptfront.TsApp.controller.Main')
			}
