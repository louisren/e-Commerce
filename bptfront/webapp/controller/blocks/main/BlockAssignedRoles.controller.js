sap.ui.define([
    ...
    class BlockAssignedRoles extends BaseController {
        constructor() {
            ...
            const fnClass = BaseController.extend('bptfront.TsApp.controller.BlockAssignedRoles', {});
            BlockAssignedRoles.prototype.getMetadata = fnClass.prototype.getMetadata;
            super('bptfront.TsApp.controller.BlockAssignedRoles');
        }
        onInit() {
            // @ts-ignore
...
//# sourceMappingURL=BlockAssignedRoles.controller.js.map