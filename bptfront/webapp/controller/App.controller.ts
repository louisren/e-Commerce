sap.ui.define(
	['bptfront/TsApp/controller/BaseController', 'sap/ui/model/json/JSONModel'],
	function (
		Controller: typeof bptfront.TsApp.controller.BaseController,
		...
		class App extends Controller {
			constructor() {
				...
				const fnClass = Controller.extend('bptfront.TsApp.controller.App', {})
				App.prototype.getMetadata = fnClass.prototype.getMetadata

				super('bptfront.TsApp.controller.App')
			}
