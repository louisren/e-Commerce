 ...
 */
sap.ui.define(
	['sap/m/MessageStrip', 'sap/m/MessageStripRenderer', 'sap/ui/core/Popup', 'sap/ui/layout/VerticalLayout'],
		...
		var StripToastr = {
			...
			getContainer: function (oSettings) {
				...
				if (!oContainer && oSettings) {
					...
					oPopup.open(0, oSettings.position, oSettings.position, oSettings.anchor, oSettings.offset)
				}
