sap.ui.define(
	...
	function (
		...
		class Main extends BaseController {
			formatter: pscctoolsfront.TsApp.formatter.Formatter
			...
			constructor() {
				...
				const fnClass = BaseController.extend('pscctoolsfront.TsApp.controller.Main', {})
				Main.prototype.getMetadata = fnClass.prototype.getMetadata

				super('pscctoolsfront.TsApp.controller.Main')
			}
