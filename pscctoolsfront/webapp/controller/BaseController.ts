	...
	function (
		...
		class BaseController extends Controller {
			...
			constructor() {
				...
				const fnClass = Controller.extend('pscctoolsfront.TsApp.controller.BaseController', {})
				BaseController.prototype.getMetadata = fnClass.prototype.getMetadata

				super('pscctoolsfront.TsApp.controller.BaseController')
			}

			// eslint-disable-next-line @typescript-eslint/no-empty-function
			public onInit(): void {}

			public getOwnerAppComponent(): pscctoolsfront.TsApp.Component {
				...
				const comp = (this.getOwnerComponent() as any) as pscctoolsfront.TsApp.Component
				return comp
			}
